...
const FormularioEditar = () => {
	...
	const { discos, editarDisco, lanzarError, lanzarExito } = useDiscos();
	...
	const guardarCambios = () => {
		...
		if (erroresVal.length > 0) {
			...
			let discoActualizado = recogerDatos(formulario);
			editarDisco(id, discoActualizado);

			lanzarExito('Disco modificado correctamente');
		...
		<>
			<div id="divForm">
				<form id="formulario" name="formulario">
					<h3>Editar disco: {formulario.nombre}</h3>
					...
					<input
						...
						id="prestado"
						name="prestado"
						checked={formulario.prestado === true || formulario.prestado === 'true'}
						onChange={actualizarForm}
					/>
					<br />
					<input
